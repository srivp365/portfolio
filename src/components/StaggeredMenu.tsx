...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-40 ${isFixed ? "fixed top-0 left-0 w-screen h-screen overflow-hidden" : "w-full h-full"} pointer-events-none`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto mb-1 ${
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1rem; font-weight: 500; color: var(--sm-accent, #ffffff); }
...
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: white; text-transform: uppercase; }
